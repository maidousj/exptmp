...
# A, paths
data_path = "/data/pythonsolution/input/"
train = data_path+'train_flip_0.5.csv'               # path to training file
test = data_path+'test.csv'                 # path to testing file
submission = '/data/pythonsolution/output/sub_proba_test_flip.csv'  # path of to be outputted submission file
